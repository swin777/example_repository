...
const nowZoomText:HTMLSpanElement = document.getElementById("nowZoom") as HTMLSpanElement; //현재 zoom text
const zoomSelect:HTMLInputElement = document.getElementById("zoom") as HTMLInputElement; //zoom 선택 
const nowBearingText:HTMLSpanElement = document.getElementById("nowBearing") as HTMLSpanElement; //현재 bearing text
const bearingSelect:HTMLInputElement = document.getElementById("bearing") as HTMLInputElement; //bearing 선택 
const nowPitchText:HTMLSpanElement = document.getElementById("nowPitch") as HTMLSpanElement; //현재 pitch text
const pitchSelect:HTMLInputElement = document.getElementById("pitch") as HTMLInputElement; //pitch 선택 
