...
map.on("load", () => {
    ...
    // 점이 회전하는 원의 중심
    const center:number[] = [127.029414, 37.471401];
    ...
    // 점 이동 애니메이션 함수
    function animateMarker():void {
        // point source 좌표 갱신
        (layer.getSource() as unknown as ktGms.source.GeoJSONSource).setData(new ktGms.geometry.PointGeo([
