...
const layerIDs:string[] = []; // 필터된 layer의 ID를 담을 배열
const filterInput:HTMLElement = document.getElementById("filter-input")!; //사용자가 입력하는 input 
...
map.on("load", () => {
    ...
    filterInput.addEventListener("keyup", (e:any) => {
